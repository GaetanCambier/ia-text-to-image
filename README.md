...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ia-text-to-image
```

A live public deployment of this template is available at [https://ia-text-to-image.templates.workers.dev](https://ia-text-to-image.templates.workers.dev)
